    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Coin2College Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Coin2College address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coin2college: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Coin2College Core"), this);
    aboutAction->setStatusTip(tr("Show information about Coin2College Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Coin2College Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Coin2College addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Coin2College addresses"));
    ...
    openAction->setStatusTip(tr("Open a coin2college: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Coin2College Core help message to get a list with possible Coin2College Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Coin2College Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Coin2College network", "", count));
    } else {
...
{
    QString strTitle = tr("Coin2College Core"); // default title
    ...
    // Append title to "Coin2College Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
