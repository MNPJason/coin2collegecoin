...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    ...
    else
    {
        ...
        // if user has selected to set a minimum coin2college fee, pass the value to coincontrol
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Coin2College address"));
        }
        else // Valid address
        {
            CKeyID keyid;
...
void SendCoinsDialog::coinControlUpdateLabels()
{
    ...
    {
        // enable minimum coin2college fee UI controls
    ...
    {
        // in case coin control is disabled (=default), hide minimum coin2college fee UI controls
