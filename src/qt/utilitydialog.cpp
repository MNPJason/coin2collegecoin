    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Coin2College Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Coin2College Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  coin2college-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Coin2College in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 C2C, 0.1 C2C, 1 C2C and 10 C2C -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Coin2College Core is shutting down...") + "<br /><br />" +
