...
2. run coin2colleged with -printalert or -sendalert like this:
   /path/to/coin2colleged -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.coin2collegecrypto.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Coin2College Core:0.12.0.58/"));
