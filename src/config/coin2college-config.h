/* src/config/coin2college-config.h.  Generated from coin2college-config.h.in by configure.  */
/* src/config/coin2college-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef COIN2COLLEGE_CONFIG_H

#define COIN2COLLEGE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/coin2collegecrypto/coin2collegecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Coin2College Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Coin2College Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coin2collegecore"
