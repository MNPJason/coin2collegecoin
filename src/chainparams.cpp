...
{
    const char* pszTimestamp = "Coin2College is up and running on 03 15 2018";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1518598800, 1862755, 0x1e0ffff0, 1, 30 * COIN);
        ...
        // Coin2College script addresses start with 's'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,125);
        // Coin2College private keys start with 'm'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,110);
        // Coin2College BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Coin2College BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Coin2College BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("ts1.coin2college.com", "ts1.coin2college.com"));
        vSeeds.push_back(CDNSSeedData("ts2.coin2college.com", "ts2.coin2college.com"));
        vSeeds.push_back(CDNSSeedData("ts3.coin2college.com", "ts3.coin2college.com"));

        // Testnet Coin2College addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Coin2College script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Coin2College BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Coin2College BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Coin2College BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Coin2College: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Coin2College: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
 ...
 //coinstew       assert(genesis.hashMerkleRoot == uint256S("0x8b377c1c53e941fa9bb77eb87265de1905d6dc8180e90eb81c54f6d51053888f"));
        ...
        // Regtest Coin2College addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Coin2College script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Coin2College BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Coin2College BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Coin2College BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
