...
#ifdef ENABLE_COIN2COLLEGE_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
 ...
 */
template <typename Callable> void Tcoin2collegeThread(const char* name,  Callable func)
{
    std::string s = strprintf("coin2college-%s", name);
