...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Coin2College Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  coin2college-cli [options] <command> [params]  " + _("Send command to Coin2College Core") + "\n" +
                  "  coin2college-cli [options] help                " + _("List commands") + "\n" +
                  "  coin2college-cli [options] help <command>      " + _("Get help for a command") + "\n";
