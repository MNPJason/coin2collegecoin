...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total coin2college balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized coin2college balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "coin2college|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "coin2college")
            + HelpExampleRpc("debug", "coin2college,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"coin2collegeaddress\"\n"
            "\nReturn information about the given coin2college address.\n"
            "\nArguments:\n"
            "1. \"coin2collegeaddress\"     (string, required) The coin2college address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"coin2collegeaddress\", (string) The coin2college address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Coin2College address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are coin2college addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) coin2college address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"coin2collegeaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"coin2collegeaddress\"  (string, required) The coin2college address to use for the signature.\n"
