...
#define BOOST_TEST_MODULE Coin2College Test Suite

#include "test_coin2college.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_coin2college_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
