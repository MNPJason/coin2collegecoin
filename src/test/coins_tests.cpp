...
#include "test/test_coin2college.h"
...
const static auto C2CENT_FLAGS = {NO_ENTRY};
...
public:
    ...
    {
        WriteCoinsViewEntry(base, base_value, base_value == C2CENT ? NO_ENTRY : DIRTY);
...
BOOST_AUTO_TEST_CASE(ccoins_access)
{
     ...
     */
    CheckAccessCoin(C2CENT, C2CENT, C2CENT, NO_ENTRY   , NO_ENTRY   );
    CheckAccessCoin(C2CENT, PRUNED, PRUNED, 0          , 0          );
    CheckAccessCoin(C2CENT, PRUNED, PRUNED, FRESH      , FRESH      );
    CheckAccessCoin(C2CENT, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckAccessCoin(C2CENT, PRUNED, PRUNED, DIRTY|FRESH, DIRTY|FRESH);
    CheckAccessCoin(C2CENT, VALUE2, VALUE2, 0          , 0          );
    CheckAccessCoin(C2CENT, VALUE2, VALUE2, FRESH      , FRESH      );
    CheckAccessCoin(C2CENT, VALUE2, VALUE2, DIRTY      , DIRTY      );
    CheckAccessCoin(C2CENT, VALUE2, VALUE2, DIRTY|FRESH, DIRTY|FRESH);
    CheckAccessCoin(PRUNED, C2CENT, C2CENT, NO_ENTRY   , NO_ENTRY   );
    ...
    CheckAccessCoin(VALUE1, C2CENT, VALUE1, NO_ENTRY   , 0          );
...
BOOST_AUTO_TEST_CASE(ccoins_spend)
{
     ...
     *              Value   Value   Value   Flags        Flags
     */
    CheckSpendCoins(C2CENT, C2CENT, C2CENT, NO_ENTRY   , NO_ENTRY   );
    CheckSpendCoins(C2CENT, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(C2CENT, PRUNED, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(C2CENT, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(C2CENT, PRUNED, C2CENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(C2CENT, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(C2CENT, VALUE2, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(C2CENT, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(C2CENT, VALUE2, C2CENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(PRUNED, C2CENT, C2CENT, NO_ENTRY   , NO_ENTRY   );
    CheckSpendCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(PRUNED, PRUNED, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(PRUNED, PRUNED, C2CENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(PRUNED, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(PRUNED, VALUE2, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(PRUNED, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(PRUNED, VALUE2, C2CENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(VALUE1, C2CENT, PRUNED, NO_ENTRY   , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(VALUE1, PRUNED, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(VALUE1, PRUNED, C2CENT, DIRTY|FRESH, NO_ENTRY   );
    CheckSpendCoins(VALUE1, VALUE2, PRUNED, 0          , DIRTY      );
    CheckSpendCoins(VALUE1, VALUE2, C2CENT, FRESH      , NO_ENTRY   );
    CheckSpendCoins(VALUE1, VALUE2, PRUNED, DIRTY      , DIRTY      );
    CheckSpendCoins(VALUE1, VALUE2, C2CENT, DIRTY|FRESH, NO_ENTRY   );
}
...
{
    for (CAmount base_value : {C2CENT, PRUNED, VALUE1})
...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
     ...
     *           Value   Value   Value   Flags        Flags
     */
    CheckAddCoin(C2CENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY|FRESH, false);
    CheckAddCoin(C2CENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY      , true );
...
{
    SingleEntryCacheTest test(C2CENT, parent_value, parent_flags);
...
BOOST_AUTO_TEST_CASE(ccoins_write)
{
     ...
     */
    CheckWriteCoins(C2CENT, C2CENT, C2CENT, NO_ENTRY   , NO_ENTRY   , NO_ENTRY   );
    CheckWriteCoins(C2CENT, PRUNED, PRUNED, NO_ENTRY   , DIRTY      , DIRTY      );
    CheckWriteCoins(C2CENT, PRUNED, C2CENT, NO_ENTRY   , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(C2CENT, VALUE2, VALUE2, NO_ENTRY   , DIRTY      , DIRTY      );
    CheckWriteCoins(C2CENT, VALUE2, VALUE2, NO_ENTRY   , DIRTY|FRESH, DIRTY|FRESH);
    CheckWriteCoins(PRUNED, C2CENT, PRUNED, 0          , NO_ENTRY   , 0          );
    CheckWriteCoins(PRUNED, C2CENT, PRUNED, FRESH      , NO_ENTRY   , FRESH      );
    CheckWriteCoins(PRUNED, C2CENT, PRUNED, DIRTY      , NO_ENTRY   , DIRTY      );
    CheckWriteCoins(PRUNED, C2CENT, PRUNED, DIRTY|FRESH, NO_ENTRY   , DIRTY|FRESH);
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY      , DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, 0          , DIRTY|FRESH, DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, C2CENT, FRESH      , DIRTY      , NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, C2CENT, FRESH      , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY      , DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, PRUNED, DIRTY      , DIRTY|FRESH, DIRTY      );
    CheckWriteCoins(PRUNED, PRUNED, C2CENT, DIRTY|FRESH, DIRTY      , NO_ENTRY   );
    CheckWriteCoins(PRUNED, PRUNED, C2CENT, DIRTY|FRESH, DIRTY|FRESH, NO_ENTRY   );
    ...
    CheckWriteCoins(VALUE1, C2CENT, VALUE1, 0          , NO_ENTRY   , 0          );
    CheckWriteCoins(VALUE1, C2CENT, VALUE1, FRESH      , NO_ENTRY   , FRESH      );
    CheckWriteCoins(VALUE1, C2CENT, VALUE1, DIRTY      , NO_ENTRY   , DIRTY      );
    CheckWriteCoins(VALUE1, C2CENT, VALUE1, DIRTY|FRESH, NO_ENTRY   , DIRTY|FRESH);
    CheckWriteCoins(VALUE1, PRUNED, PRUNED, 0          , DIRTY      , DIRTY      );
    CheckWriteCoins(VALUE1, PRUNED, FAIL  , 0          , DIRTY|FRESH, NO_ENTRY   );
    CheckWriteCoins(VALUE1, PRUNED, C2CENT, FRESH      , DIRTY      , NO_ENTRY   );
    ...
    CheckWriteCoins(VALUE1, PRUNED, C2CENT, DIRTY|FRESH, DIRTY      , NO_ENTRY   );
    ...
    for (CAmount parent_value : {C2CENT, PRUNED, VALUE1})
        for (CAmount child_value : {C2CENT, PRUNED, VALUE2})
            for (char parent_flags : parent_value == C2CENT ? C2CENT_FLAGS : FLAGS)
                for (char child_flags : child_value == C2CENT ? C2CENT_FLAGS : CLEAN_FLAGS)
