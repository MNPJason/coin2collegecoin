 ...
 *
 *   // network
 *   CCoin2CollegeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CCoin2CollegeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCoin2CollegeNetwork(UniValue objIn)
    {
...
// // can be under: Coin2CollegeNetwork
// //   -- signature requirements : Key1(User)
// class CCoin2CollegeNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == Coin2CollegeNetwork);
//     // }
