...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 400 C2C serialized is 00902f5009000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 500C2C for another
        ...
        # Check node0's total balance; should be same as before the clone, + 1000 C2C for 2 matured,
