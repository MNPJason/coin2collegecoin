...
Only requiring some minor changes is coin2college.cpp.
...
Changes to coin2college.cpp
----------------------
coin2college.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
