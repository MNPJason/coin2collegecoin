...
- #6719 `1a9f19a` Make HTTP server shutdown more gcoin2collegeful (Wladimir J. van der Laan)
...
- #7438 `e2d9a58` Do not coin2collegely protect local peers; decide group ties based on time (Gregory Maxwell)
...
- #7096 `9490bd7` [Wallet] Improve minimum coin2college fee GUI options (Jonas Schnelli)
...
- #6509 `bb4faee` Fix coin2college condition on test node shutdown (Casey Rodarmor)
